# ADR-006: Tool Registry and Tool Calling
...
AI-selected actions require explicit registration, validation, authorization, and auditability.

## Decision

Execute tools only through the approved registry and business authorization boundaries.
