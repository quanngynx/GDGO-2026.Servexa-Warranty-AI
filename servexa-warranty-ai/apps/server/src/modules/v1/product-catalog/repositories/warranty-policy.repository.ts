...
import type { IWarrantyPolicyRepository, WarrantyPolicyOptions } from '../interfaces/warranty-policy-repository.interface'
...
export class WarrantyPolicyRepository implements IWarrantyPolicyRepository {
  ...
  async findOneById<TSelect extends WarrantyPolicySelect | undefined, TInclude extends WarrantyPolicyInclude | undefined>(
    id: string,
  ...
  async findOverlapping(
    ...
    const where: Prisma.WarrantyPolicyWhereInput = {
      warrantyType,
      status: 'active',
      ...(target.categoryId ? { categoryId: target.categoryId, modelId: null } : { modelId: target.modelId, categoryId: null }),
      AND: [
  ...
  async createOne<TSelect extends WarrantyPolicySelect | undefined, TInclude extends WarrantyPolicyInclude | undefined>(
  ...
  async updateOneById<TSelect extends WarrantyPolicySelect | undefined, TInclude extends WarrantyPolicyInclude | undefined>(
    id: string,
