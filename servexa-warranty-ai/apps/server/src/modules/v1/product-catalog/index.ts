...
export type { IAscCenterRepository, IAscCenterService } from './interfaces/asc-center.interface'
...
export type { FindAllAscCentersInput } from './services/asc-center.service'
