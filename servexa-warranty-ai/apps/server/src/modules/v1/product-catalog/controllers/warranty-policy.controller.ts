...
export class WarrantyPolicyController {
  ...
  constructor(
    private readonly warrantyPolicyService: IWarrantyPolicyService = new WarrantyPolicyService(),
  ) {
  ...
  findOneById = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      const { warrantyPolicyId } = findWarrantyPolicyByIdSchema.parse(
        req.params,
      );
      const result =
        await this.warrantyPolicyService.findOneById(warrantyPolicyId);
  ...
  replace = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      const result = await this.warrantyPolicyService.update(
        warrantyPolicyId,
        body,
      );
