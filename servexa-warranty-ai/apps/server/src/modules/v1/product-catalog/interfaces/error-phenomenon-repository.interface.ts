...
export interface IErrorPhenomenonRepository {
  findAll(query: Prisma.ErrorPhenomenonFindManyArgs): Promise<(ErrorPhenomenon & Prisma.ErrorPhenomenonInclude)[] | null>
  ...
  createManyAndReturn(data: Prisma.ErrorPhenomenonCreateManyInput[]): Promise<(ErrorPhenomenon & Prisma.ErrorPhenomenonInclude)[] | null>
}
