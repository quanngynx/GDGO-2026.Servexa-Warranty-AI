...
export class EmployeeController {
  ...
  constructor(private readonly employeeService: IEmployeeService = new EmployeeService()) {
  ...
  findAll = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      new SuccessResponse({ message: 'Employees fetched successfully', metadata: result }).send(res)
    })(req, res, next)
  }
  ...
  findOneById = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      new SuccessResponse({ message: 'Employee fetched successfully', metadata: result }).send(res)
    })(req, res, next)
  }
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      new SuccessResponse({ message: 'Employee created successfully', status: 201, metadata: result }).send(res)
    })(req, res, next)
  }
  ...
  replace = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      new SuccessResponse({ message: 'Employee updated successfully', metadata: result }).send(res)
    })(req, res, next)
  }
  ...
  linkUser = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      new SuccessResponse({ message: 'Employee linked successfully', metadata: result }).send(res)
    })(req, res, next)
  }
  ...
  delete = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      new SuccessResponse({ message: 'Employee deleted successfully', metadata: result }).send(res)
    })(req, res, next)
  }
}
