...
<img src='https://fumadocs.dev/themes/neutral.png' alt='Neutral theme preview' />

    </Tab>

    <Tab value='black'>

<img src='https://fumadocs.dev/themes/black.png' alt='Black theme preview' />

    </Tab>

    <Tab value='vitepress'>

<img src='https://fumadocs.dev/themes/vitepress.png' alt='Vitepress theme preview' />

    </Tab>

    <Tab value='dusk'>

<img src='https://fumadocs.dev/themes/dusk.png' alt='Dusk theme preview' />

    </Tab>

    <Tab value='Catppuccin'>

<img src='https://fumadocs.dev/themes/catppuccin.png' alt='Catppuccin theme preview' />

    </Tab>

    <Tab value='ocean'>

<img src='https://fumadocs.dev/themes/ocean.png' alt='Ocean theme preview' />

    </Tab>

    <Tab value='purple'>

<img src='https://fumadocs.dev/themes/purple.png' alt='Purple theme preview' />

    </Tab>

  <Tab value='solar'>

    <img src='https://fumadocs.dev/themes/solar.png' alt='Solar theme preview' />
