...
import type {
  CreateTotalWarehouseDto,
  ReplaceTotalWarehouseDto,
  UpdateTotalWarehouseDto,
} from "../dtos/total-warehouse.dto";
...
export interface ITotalWarehouseRepository {
  findAll(
    query: Prisma.TotalWarehouseFindManyArgs,
...
export interface ITotalWarehouseService {
  ...
  update(
    ...
    input: ReplaceTotalWarehouseDto | UpdateTotalWarehouseDto,
    updatedBy: string,
  ): Promise<unknown>;
