...
export class TechnicianController {
  ...
  constructor(
    private readonly technicianService: ITechnicianService = new TechnicianService(),
  ) {
  ...
  findOneById = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      const { technicianProfileId } = findTechnicianByIdSchema.parse(
        req.params,
      );
      const result =
        await this.technicianService.findOneById(technicianProfileId);
      new SuccessResponse({
  ...
  replace = async (req: Request, res: Response, next: NextFunction) => {
    return this.errorHandler.asyncHandler(async () => {
      ...
      const result = await this.technicianService.update(
        technicianProfileId,
        body,
      );
      new SuccessResponse({
